        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                for val_data in val_loader:
                    ...
                    input1 = val_data['L']
                    flops, params = profile(model.netG, inputs=(input1,))
                    ...
                    rain = util.tensor2uint(visuals['rain'])
                ...
                # --------------------validating log--------------------
                logger.info(
                    '<epoch:{:3d}, iter:{:8,d}, Average PSNR : {:.4f} , SSIM : {:.4f} , PSNR_b : {:.4f} , PSNR_y : {:.4f} , SSIM_y : {:.4f}\n'.format(
                        epoch, current_step, avg_psnr, avg_ssim, avg_psnr_b, avg_psnr_y, avg_ssim_y))
